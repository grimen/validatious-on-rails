...
** @validates_acceptance_of@ - <small>no support: :accept, :allow_nil, :on, :if, :unless / Hint: To avoid issues, check Rails API for :accept-option - if this is incorrectly set, your validations may act very strange. *validates_presence_of* always works though.</small>
** @validates_confirmation_of@ - <small>partial support: :allow_blank / no support: :on, :if, :unless</small>
** @validates_exclusion_of@ - <small>partial support: :allow_blank / no support: :on, :if, :unless</small>
** @validates_format_of@ - <small>partial support: :allow_blank / no support: :on, :if, :unless</small>
** @validates_inclusion_of@ - <small>partial support: :allow_blank / no support: :on, :if, :unless</small>
** @validates_length_of@ - <small>partial support: :allow_blank / no support: :on, :if, :unless</small>
** @validates_numericality_of@ - <small>no support: :only_integer, :greater_than, :greater_than_or_equal_to, :equal_to, :less_than, :less_than_or_equal_to, :odd, :even, :on, :if, :unless</small>
** @validates_presence_of@ - <small>partial support: :allow_blank / no support: :on, :if, :unless</small>
** @validates_size_of@ - <small>partly: :allow_blank - not supported: :on, :if, :unless</small>
** _(More to come...)_
* Ruby representation of @v2.Validator@ - for custom validators (public API announced soon)
* I18n-support (validation error messages) - using Rails conventions
...
* Full I18n-support - backed by Rails I18n
* Full coverage tests
...
*Note:* For testing, get "context":http://github.com/jeremymcanally/acts_as_fu, "rr":http://github.com/btakita/rr, "acts_as_fu":http://github.com/nakajima/acts_as_fu.
...
<head>
  ...
  <%= ValidatiousOnRails.custom_validators # 2) %>
  ...
</head>
</pre>
...
For all you "Formtastic":http://github.com/justinfrench/formtastic users out there: This plugin is out-of-the-box compatible with Formtastic - unlike the similar solution(s) out there. But to get Validatious and Formtastic to play well with each other, you need to tweak the *configuration* settings a bit. These settings is very much recommended:
