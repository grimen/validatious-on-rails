...
** @uniqueness_of@ (AJAX-based)- <small>except :on, :if/:unless</small> *new*
...
_*Note:* This project is under heavy development; a lot of experimenting going on - things might change under the hood. See the "TODO":http://github.com/grimen/validatious-on-rails/blob/master/TODO for more info._ Please help out file any issues/problems.
...
$ ./script/generate validatious
      ...
      create  public/javascripts/validatious-on-rails.js
</pre>
