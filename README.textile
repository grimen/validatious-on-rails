...
** @validates_acceptance_of@ (Hint: To avoid issues, check Rails API for :accept-option - if this is incorrectly set, your validations may act very strange. @validates_presence_of@ always works though.)
*** no support: :accept, :allow_nil, :on, :if, :unless
** @validates_confirmation_of@
*** partial support: :allow_blank
*** no support: :on, :if, :unless
...
*** no support: :only_integer, :greater_than, :greater_than_or_equal_to, :equal_to, :less_than, :less_than_or_equal_to, :odd, :even, :on, :if, :unless
** @validates_presence_of@
*** partial support: :allow_blank
*** no support: :on, :if, :unless
** @validates_size_of@
*** partly: :allow_blank
*** not supported: :on, :if, :unless
** _(More to come...)_
