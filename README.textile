...
** @validates_acceptance_of@ - <small>no support: :on, :if, :unless</small>
...
* Should be very easy to extend with custom form field helpers.
...
* Full I18n-support - backed by Rails I18n API
* Solid test suit
