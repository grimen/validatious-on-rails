...
** @validates_numericality_of@ - <small>no support: :on, :if, :unless</small>
** @validates_presence_of@ - <small>partial support: :allow_blank / no support: :on, :if, :unless</small>
** @validates_size_of@ - <small>partial support: :allow_blank / no support: :on, :if, :unless</small>
** _(More to come...)_
...
<pre>config.gem 'validatious-on-rails', :lib => 'validatious-on-rails', :source => 'http://gemcutter.org'</pre>
...
*Note:* For testing, get: "context":http://github.com/jeremymcanally/context, "rr":http://github.com/btakita/rr, and "acts_as_fu":http://github.com/nakajima/acts_as_fu.
