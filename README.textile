...
_Note: Just started so...expect the list to expand - especially validations._
...
* Should not only perform the validations, but also respect the Rails valdiation conditionals (such as :on, :allow_blank, etc.)
* Support all Rails core form helpers, but also new ones using pluggable interface
* Full I18n-support - backed by Rails I18n
* Full coverage tests

_Note: Somethings fundamental is missing? Let me know! =)_
